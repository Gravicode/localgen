...
public class AppConstants{
    ...
    public static List<AIModel> ListModels { get; set; } = [
        ...
        new(){ Name="gemma", Description = "Gemma is a family of lightweight, state-of-the-art open models built by Google DeepMind. Updated to version 1.1", DownloadUrl = "" , Creator = "Google Deepmind", FolderName="gemma" },
        new(){ Name="mistral", Description = "The 7B model released by Mistral AI, updated to version 0.3.\r\nTools\r\n7B", DownloadUrl = "" , Creator = "Mistral AI", FolderName="mistral" },
