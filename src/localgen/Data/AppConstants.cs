...
public class AppConstants
{
    ...
    public static List<AIModel> ListModels { get; set; } = [
        ...
        new(){ Name="llama2", Description = "Meta Llama 2: The most capable openly available LLM to date", DownloadUrl = "https://is3.cloudhost.id/cloudfile/models/llama2-7b.7z" , Creator = "Meta AI", FolderName="llama" },
        ];
}